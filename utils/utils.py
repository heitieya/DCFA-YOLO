...
#---------------------------------------------------------#
#   Convert the image to RGB format to prevent errors 
#   during prediction for grayscale images. The code 
#   only supports predictions for RGB images; all other 
#   types of images will be converted to RGB.
#---------------------------------------------------------#
def cvtColor(image):
...
#---------------------------------------------------#
#   Initialize the seed for DataLoader workers
#---------------------------------------------------#
